...
- (void)onTradeEventWithSymbols:(NSArray *)symbols listen:(BAStreamAggTradeEventBlock)eventHandleBlock {
    NSString *channels = [[[[symbols componentsJoinedByString:@"@aggTrade/"] stringByAppendingString:@"@aggTrade"] lowercaseString] stringByReplacingOccurrencesOfString:@"aggtrade" withString:@"aggTrade"];
